...
from larops.services.secure_service import SecureServiceError, apply_secure_nginx, apply_secure_ssh
...
def secure_nginx(
    ...
    login_rate: str = typer.Option("5r/m", "--login-rate", help="Rate limit for login/password routes."),
    api_rate: str = typer.Option("60r/m", "--api-rate", help="Rate limit for API routes."),
    login_burst: int = typer.Option(10, "--login-burst", help="Burst for login rate limit."),
    api_burst: int = typer.Option(120, "--api-burst", help="Burst for API rate limit."),
